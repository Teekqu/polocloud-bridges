package dev.httpmarco.polocloud.bridges.fabric.v1_21_1
...
object VelocityProtocol {
    ...
    fun readGameProfile(buf: PacketByteBuf): GameProfile =
        GameProfile(buf.readUuid(), buf.readString(16))

    private fun readProperties(buf: PacketByteBuf): PropertyMap {
        val count = buf.readVarInt()
        val propertiesBuilder = PropertyMap()
        ...
        repeat(count) {
            ...
            propertiesBuilder.put(name, Property(name, value, signature))
        }
